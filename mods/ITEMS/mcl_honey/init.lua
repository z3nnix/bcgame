...
core.register_craftitem("mcl_honey:honey_bottle", {
	...
	_doc_items_longdesc = S("Honey Bottle is used to craft honey blocks and to restore health."),
	_doc_items_usagehelp = S("Drinking will restore 6 health points. Can also be used to craft honey blocks."),
